...
treats the locked event vocabulary as ground truth and is told to flag anything
it can't verify.
...
accurate and concrete. Ground every load-bearing claim in the files named
...
Then give me, in plain language and in this order:
  ...
  - THE HONEST CAVEATS: the Discord-user-account / Terms-of-Service reality
...
Rules:
  - If a prose doc and the code/vocabulary disagree, trust the code and the
    locked vocabulary, and flag the drift explicitly.
...
way in is to let an LLM read its own contract and explain it back to you. If you
