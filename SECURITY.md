...
**Report a vulnerability** privately: open a [GitHub Security Advisory](https://github.com/laffeyp/cascade-img/security/advisories/new). Please don't file a public issue. Expect an acknowledgement within a few days.
