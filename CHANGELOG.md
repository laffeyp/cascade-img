...
- **Documentation**
  ...
  - `examples/demo/prompts/*.md` — the four prompt templates from the originating demo project, preserved as a worked example. Not generic; an example consumer's structure, not a recommended pattern.
