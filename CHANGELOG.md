...
Initial alpha. Ports the Cascade asset pipeline from Katybird's working code into a standalone package under Green Rose Systems.
...
- **Bridge daemon** (`cascade_img.backends.midjourney_discord.bridge`)
  ...
  - Both Sprint 4.0 production patches preserved:
...
- **SDD instrumentation** (`cascade_img.instrumentation.sdd`)
