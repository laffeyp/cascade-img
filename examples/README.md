...
These are illustrative, not templates to copy verbatim. For the authoritative
tool reference and the operating loop, read [AGENTS.md](../AGENTS.md) at the
project root.

- [generate-a-single-image.md](./generate-a-single-image.md) — the minimal
