...
6. Run the discipline ladder: `pytest tests/ -v`.
...
- One concern per PR; commits should match the discipline ladder shape — every commit's diff should leave the test suite green.
